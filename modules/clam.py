...
class CLAM_SB(nn.Module):
    ...
    def forward(self, h, label=None, instance_eval=True, return_features=False, attention_only=False): #RRT
    # def forward(self, h, label=None, instance_eval=False, return_features=False, attention_only=False):
    # def forward(self, h, label=1, instance_eval=True, return_features=False, attention_only=False): #RRT
